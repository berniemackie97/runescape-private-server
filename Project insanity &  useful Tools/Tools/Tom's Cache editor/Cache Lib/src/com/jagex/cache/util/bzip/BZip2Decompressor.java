package com.jagex.cache.util.bzip;
...
public class BZip2Decompressor {
    ...
    private static void readBlock(BZip2BlockEntry blockEntry) {
        ...
        if (blockEntry.ll8 == null)
            blockEntry.ll8 = new int[blockEntry.blockSize100k * 0x186a0];
        boolean flag19 = true;
        while (flag19) {
            ...
            for (int nextSym = perm_zt[zvec - base_zt[zn]]; nextSym != eob;)
                if (nextSym == 0 || nextSym == 1) {
                    ...
                    byte tmp;
                    if (j11 < 16) {
                        int j10 = blockEntry.anIntArray593[0]; //should be 0!!!!
                    ...
                    blockEntry.ll8[i6] = blockEntry.seqToUnseq[tmp & 0xff] & 0xff;
                    i6++;
                    if (groupPos == 0) {
                        lastShadow++;
                        groupPos = 50;
            ...
            for (int l2 = 0; l2 < i6; l2++) {
                byte byte7 = (byte) (blockEntry.ll8[l2] & 0xff);
                blockEntry.ll8[blockEntry.anIntArray585[byte7 & 0xff]] |= l2 << 8;
                blockEntry.anIntArray585[byte7 & 0xff]++;
            }

            blockEntry.anInt581 = blockEntry.ll8[blockEntry.origPtr] >> 8;
            blockEntry.anInt584 = 0;
            blockEntry.anInt581 = blockEntry.ll8[blockEntry.anInt581];
            blockEntry.anInt582 = (byte) (blockEntry.anInt581 & 0xff);
            blockEntry.anInt581 >>= 8;
            blockEntry.anInt584++;
            blockEntry.anInt601 = i6;
            method226(blockEntry);
            flag19 = blockEntry.anInt584 == blockEntry.anInt601 + 1 && blockEntry.anInt574 == 0;
        }
    }
